...
<div class="wrapper">
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
      ...
      <ul class="sidebar-menu"> 
        ...
        <li class="<?php echo (currentpage() == 'prescription') ? "active" : false;?>" > 
          <a href="<?php echo web_root ;?>prescription/">
            <i class="fa fa-barcode"></i> <span>Add Prescription to Patients</span>  
          </a>
        </li> 
         <?php if($_SESSION['ADMIN_ROLE']=="Administrator"){ ?> 
  ...
  <footer class="main-footer no-print">
    ...
    <strong>Copyright &copy; 2022 <a href="https://www.linkedin.com/in/sahil-santosh-kedar/">SahilKedar</a>.</strong> All rights
    reserved.
  </footer>
